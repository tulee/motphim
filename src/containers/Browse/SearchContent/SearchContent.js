...
const SearchContent = props => {
    ...
    const getSearchMovies = async (searchItem) => {
        const movieUrl = `search/movie?api_key=${apiKey}&language=en-US&query=${searchItem}&page=1&include_adult=false`
        const tvUrl = `search/tv?api_key=${apiKey}&language=en-US&page=1&query=${searchItem}&include_adult=false`
